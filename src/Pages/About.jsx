    ...
    return (
        <div className="dark:bg-black dark:text-white min-h-screen flex items-center justify-center">
            <div className="max-w-3xl p-8 dark:text-white shadow-xl rounded-lg">
                <h2 className="dark:text-white text-3xl text-yellow-300 font-bold mb-4">Hi Everyone!</h2>
                <p className="text-xl font-bold dark:text-white text-yellow-300 leading-relaxed">
                My name is Truong Thanh Nhan, but you can call me Nhan or Nigel.
                </p>
                <p className="text-lg dark:text-white text-yellow-300 leading-relaxed mt-4">
                ...
                <a href="https://drive.google.com/file/d/1Nflm3H8OApeXeIriv9a2zwk7Sb4y93x9/view?usp=sharing" className="inline-block mt-8 border-black bg-blue-750 bg-yellow-200 hover:bg-yellow-500 dark:border-2 dark:bg-white dark:text-black dark:hover:bg-gray-500 text-black py-2 px-4 rounded-lg transition duration-300 ease-in-out">Download My CV</a>
